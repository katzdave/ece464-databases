...
The first half of the course will be focused on relational databases, and we'll primarily work with PostgreSQL. The official course language is Python, but there will be some flexibility on the final project.

The second half of the course will be focused on other types of databases, storaging large amounts of data at scale, and modern software engineering and system design concepts.

#### Lectures

Lectures are held once a week, Thursday 1800-2100. Attendance is expected; I strongly advise all students to attend every lecture. Lack of attendance will degrade performance in the class and more importantly degrade knowledge of databases.
...
###### Week 11: Normalization and Database Design. Large scale system design.
* R&G Chapters 19
...
###### Week 13: Vector and Graph databases
